...
const initialConstants = {
  ...
  DEFAULT_LIGHT_BRAND_COLOR: "#7c45f3",
  DEFAULT_DARK_BRAND_COLOR: "#9065ef",
  CALCOM_VERSION: "0.0.0",
  IS_SELF_HOSTED: false,
  SEO_IMG_DEFAULT: "https://jeroenandpaws.com/og-image.png",
  SEO_IMG_OGIMG: "https://jeroenandpaws.com/og-image-wide.png",
  CURRENT_TIMEZONE: "Europe/London",
  APP_NAME: "jeroenandpaws.com",
